...
export function BenefitCard(props) {
  return (
    <div className="flex flex-col flex-grow w-full md:w-64 lg:w-1/4 rounded-lg shadow pt-5 pb-5 pl-6 pr-6 m-1">
      ...
      <p className="m-auto truncate-4-lines w-full">{props.description}</p>
