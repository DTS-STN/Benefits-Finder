...
describe("benefits helper functions", () => {
  ...
  it("gets a list of benefits", async () => {
    ...
    expect(data[0].title === "Allowance for the Survivor");
    expect(data[1].title === "Guaranteed Income Supplement (GIC)");
  });
  ...
  it("gets benefit data for a specific benefit - English", async () => {
    ...
    expect(data.id === 2);
    expect(data.title === "Allowance for the Survivor");
  });
  ...
  it("gets benefit data for a specific benefit - French", async () => {
    ...
    expect(data.id === 2);
    expect(data.title === "(FR) Allowance for the Survivor");
  });
});
